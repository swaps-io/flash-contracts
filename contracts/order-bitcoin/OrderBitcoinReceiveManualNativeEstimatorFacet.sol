...
contract OrderBitcoinReceiveManualNativeEstimatorFacet is IOrderBitcoinReceiveManualNativeEstimator, Estimator {
    function estimateReceiveOrderBitcoinAssetManualNative(
        ...
        _receiveOrderBitcoinAssetManualNative(order_, toSignature_, caller_, NativeLib.VALUE_ORIGINAL_BIT);
    }
    ...
    function estimateReceiveOrderBitcoinAssetManualNative(
        ...
        _receiveOrderBitcoinAssetManualNative(order_, toSignature_, caller_, value_);
    }

    function _receiveOrderBitcoinAssetManualNative(OrderBitcoin calldata order_, bytes calldata toSignature_, address caller_, uint256 value_) private {
