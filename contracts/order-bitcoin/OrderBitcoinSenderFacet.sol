...
import {IOrderBitcoinSender} from "./interfaces/IOrderBitcoinSender.sol";

import {OrderBitcoinHashLib, OrderBitcoin} from "./OrderBitcoinHashLib.sol";

contract OrderBitcoinSenderFacet is IOrderBitcoinSender {
    function sendOrderBitcoinAsset(OrderBitcoin calldata order_) external {
    ...
    function sendOrderBitcoinLiqAsset(OrderBitcoin calldata order_) external {
    ...
    function reportOrderBitcoinNoSend(OrderBitcoin calldata order_) external {
